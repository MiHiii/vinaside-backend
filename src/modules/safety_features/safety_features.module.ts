...
import { SafetyFeature, SafetyFeatureSchema } from './schemas/safety_feature.schema';

@Module({
  imports: [
    MongooseModule.forFeature([{ name: SafetyFeature.name, schema: SafetyFeatureSchema }]),
  ],
